...
class RectangularRoom(object):
    ...
    def dirty_room(self, dirt_amount):
        for tile in self.tiles.keys():
            self.tiles[tile] = dirt_amount
    ...
    def is_position_in_room(self, pos):
        ...
        if position in self.tiles.keys():
            return True
        else:
            return False
...
class Robot(object):
    ...
    def set_robot_direction(self, direction):
        ...
        """
        self.direction = round(direction, 1)
...
class EmptyRoom(RectangularRoom):
    ...
    def get_random_position(self):
        ...
        """
        return Position(round(random.random() * self.width, 1), round(random.random() * self.height, 1))
...
class FurnishedRoom(RectangularRoom):
    ...
    def is_position_furnished(self, pos):
        ...
        """
        return FurnishedRoom.is_tile_furnished(self, math.floor(pos.get_x()), math.floor(pos.get_y()))
    ...
    def is_position_valid(self, pos):
        ...
        """
        position = (math.floor(pos.get_x()), math.floor(pos.get_y()))
        if position in self.tiles.keys() and not FurnishedRoom.is_position_furnished(self, pos):
            return True
        else:
            return False
    ...
    def get_random_position(self):
        ...
        valid = False
        while not valid:
            position = Position(round(random.random() * self.width, 1), round(random.random() * self.height, 1))
            valid = FurnishedRoom.is_position_valid(self, position)
        return position
...
class StandardRobot(Robot):
    ...
    def update_position_and_clean(self):
        ...
        if not self.room.is_position_valid(new_position):
            new_direction = self.direction
            while new_direction == self.direction:
                new_direction = round(random.random() * 360, 1)
            Robot.set_robot_direction(self, new_direction)
        else:
            Robot.set_robot_position(self, new_position)
...
def run_simulation(num_robots, speed, capacity, width, height, dirt_amount, min_coverage, num_trials,
    ...
    for trial in range(0, num_trials):
        anim = ps3_visualize.RobotVisualization(num_robots, width, height, is_furnished)
        coverage = 0
        steps_per_trial = 0
...
#       of a 20x20 room?
#
# print("Standard robot: " + 'avg time steps: ' + str(run_simulation(1, 1.0, 1, 20, 20, 3, 0.8, 50, StandardRobot)))
# print("Faulty robot: " + 'avg time steps: ' + str(run_simulation(1, 1.0, 1, 20, 20, 3, 0.8, 50, FaultyRobot)))
#
# As expected the standard robot cleaned the room in less steps than the faulty robot.
#
#
...
#
# print("10x30 room:")
# print("Standard robot: " + 'avg time steps: ' + str(run_simulation(2, 1.0, 1, 10, 30, 3, 0.8, 50, StandardRobot)))
# print("Faulty robot: " + 'avg time steps: ' + str(run_simulation(2, 1.0, 1, 10, 30, 3, 0.8, 50, FaultyRobot)))
# print("----------------------")
# print("25x12 room:")
# print("Standard robot: " + 'avg time steps: ' + str(run_simulation(2, 1.0, 1, 25, 12, 3, 0.8, 50, StandardRobot)))
# print("Faulty robot: " + 'avg time steps: ' + str(run_simulation(2, 1.0, 1, 25, 12, 3, 0.8, 50, FaultyRobot)))
# print("----------------------")
# print("50x6 room:")
# print("Standard robot: " + 'avg time steps: ' + str(run_simulation(2, 1.0, 1, 50, 6, 3, 0.8, 50, StandardRobot)))
# print("Faulty robot: " + 'avg time steps: ' + str(run_simulation(2, 1.0, 1, 50, 6, 3, 0.8, 50, FaultyRobot)))
# print("----------------------")
#
# When 2 robots are cleaning the standard one still finish with less steps but now the difference between the 2 robot
# types in less.
#
#
